...
To achieve these aims, the project adopts a Social Network Analysis (SNA) approach, which has a long-standing tradition in gang and organized crime research \cite{11-klein1967groups} \cite{12-short1965group}. Technological advancements have significantly expanded its potential \cite{13-fleisher2005fieldwork} \cite{14-morselli2009inside}. Reconstructing a gang as a social network involves linking each unit—whether a group or an individual—according to the type of relationship under investigation \cite{15-wasserman1994social}. 
