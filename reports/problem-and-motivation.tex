...
\begin{description}
    ...
    \item[Sociocultural dimension:] Examine how national composition (members’ nationality) shapes connection patterns, leadership, and cooperation within criminal organizations.
\end{description}
