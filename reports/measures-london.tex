...
The following table reports the values of the structural metrics for the London Network.\\
...
\textbf{Metric}        & \textbf{Result}                                                                               \\
    \midrule
    Density                & 0.2201          \\
        Average Degree         & 11.67           \\
        Average Path Length    & 2.05            \\
        Diameter               & 4               \\
        Avgerage Clustering Coefficient & 0.6331          \\
        Modularity             & 0.2665          \\
    \bottomrule
\end{tabularx}
...
\begin{figure}[H]
    ...
    \caption{Boxplot of London centrality metrics by Birthplace}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{London subgraphs by Birthplace (ordered from 1 to 4)}
\end{figure}
